...
if($cnt>0)
{
	   ...
	   },
	  {
	   ...
	   },
	   {
			...
			"question1": "<?php echo $s3;?>"
	   },
	    {
			
			"question2": "<?php echo $s5;?>"
	   },
	   {
	   ...
	   {
	    "twitter": "<a href='JavaScript:newPopup(&#39;https://twitter.com/intent/tweet?original_referer=https%3A%2F%2Fdev.twitter.com%2Fdocs%2Ftweet-button&amp;text=<?php echo $s3.' '.$s5.'  '.$s1;?>&#39;);' class='btn' id='b' target='new'><i></i><img src='images/twitter2.png' align='left' style='width:100%; height:auto;'/></a>"
	   },
